...
gethistory=`/usr/bin/kubectl --kubeconfig=$HOME/K8s-Lab-Questions_FreeTier/kubeconfig/"$1".config rollout history deployment "${deploymentname}""${clstnum}" |sed '1,2d' |awk {'print $1'}`
